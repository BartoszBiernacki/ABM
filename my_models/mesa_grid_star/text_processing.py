...
def variable_params_from_fname(fname):
    # fname = 'blablabla/.../results/Grid_size=(1, 1)/Id=0___N=700___Beta_mortality_pair=(0.03, 0).csv'
...
def voivodeship_from_fname(fname):
    ...
    :type fname: str
    """
    from real_data import RealData  # needs to be imported here, otherwise circular import error
    ...
    while len(fname) > 0:
        ...
        if folder_name.lower() in RealData.get_voivodeship_names():
